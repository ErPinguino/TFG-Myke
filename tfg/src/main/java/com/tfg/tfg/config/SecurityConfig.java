...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        cfg.setAllowedOriginPatterns(List.of("https://localhost:5175", "http://localhost:5175","https://localhost:5176", "http://localhost:5176", "https://localhost:3000", "http://localhost:3000"));
